...
top_200_tickers = [
    ...
    "SO", "D05.SI", "ELV", "RELX", "SHW", "AMT", "EQIX", "BN", "CRWD", "MO" ,"NIO", "XPEV", "LI",
    "QS", "RKLB", "ASTR", "SPIR" , "SATL", "SQ", "MARA", "COIN", "CRSP", "MRNA", "GRAL", "ME", "SE",
    'JMIA', 'MELI', 'BYDDF', 'MPNGF','RBLX' , 'MANA-USD', 'SAND-USD', 'PLUG', 'BE', 'ENPH', 'RDDT',
    'ALAB', 'ARQQ', 'BEAM', 'OUST','TTM', 'TCS', 'TATASTEEL', 'TATAPOWER', 'TATACHEM', 'TATACONSUM',
    ' TATAELXSI',' TATACOMM', 'TATATECH', 'TATAINVEST', 'TRENT', 'INDHOTEL', 'VOLTAS', 'RELIANCE',' ADANIENT',
    ' 005930', 'BABA',' TCEHY', 'SONY', 'TM', 'VWAGY', 'PG', 'UL', 'NSRGY', 'PEP', 'KO', 'JNJ', 'PFE', 'NVS', 'RHHBY',
    ' LVMUY', 'PPRUY', 'HESAF', 'LRLCY', 'DIS', 'NFLX', 'SPOT', 'ABNB',' UBER', 'DASH', 'ZM', 'PTON', 'BYND', 'OTLY',
    ' NVDA', 'TSLA', 'PLTR', 'SNOW', 'AMD',' COIN', 'RBLX', 'U', 'MRNA', 'CRSP', 'PLUG', 'ENPH', 'NIO', 'XPEV',' LI', 'MELI', 'SE'
]
...
#share = "https://raw.githubusercontent.com//stocky/main/images/share.gif"
